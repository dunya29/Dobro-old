/******/ (() => {
  ...
  \*******************************/
            /***/ (
                ...
                /* harmony import */ var _components_ex__WEBPACK_IMPORTED_MODULE_0__ =
                    __webpack_require__(
                        /*! ./components/ex */ "./src/js/components/ex.js"
                    );
                /* harmony import */ var _components_ex__WEBPACK_IMPORTED_MODULE_0___default =
            ...
            /***/ (
                ...
                class GraphModal {
                            ...
                            document.addEventListener(
                                ...
                                function (e) {
                                    const clickedElement =
                                        e.target.closest(`[data-graph-path]`);
                                    if (clickedElement) {
                                        let target =
                                            clickedElement.dataset.graphPath;
                                        let animation =
                                            clickedElement.dataset
                                                .graphAnimation;
                                        let speed =
                                            clickedElement.dataset.graphSpeed;
                    ...
                    focusCatch(e) {
                        ...
                        const focusedItemIndex = nodesArray.indexOf(
                        ...
                        if (
                            !e.shiftKey &&
                            focusedItemIndex === nodesArray.length - 1
                        ) {
                            nodesArray[0].focus();
                            e.preventDefault();
                        }
            ...
            /***/ (
                ...
                class GraphTabs {
                    constructor(selector, options) {
                        ...
                        if (this.tabs) {
                            this.tabList =
                                this.tabs.querySelector(".tabs__nav");
                            this.tabsBtns =
                                this.tabList.querySelectorAll(".tabs__nav-btn");
                            this.tabsPanels =
                                this.tabs.querySelectorAll(".tabs__panel");
                        } else {
                    ...
                    switchTabs(
                        newTab,
                        oldTab = this.tabs.querySelector("[aria-selected]")
                    ) {
                        newTab.focus();
  ...
  \*********************************************************/
            /***/ (
                ...
                /* harmony export */ __webpack_require__.d(
                    __webpack_exports__,
                    {
                        /* harmony export */ MultiDrag: () =>
                            /* binding */ MultiDragPlugin,
                        /* harmony export */ Sortable: () =>
                            /* binding */ Sortable,
                        /* harmony export */ Swap: () =>
                            /* binding */ SwapPlugin,
                        /* harmony export */ default: () =>
                ...
                function userAgent(pattern) {
                    if (typeof window !== "undefined" && window.navigator) {
                        return !!(
                            /*@__PURE__*/ navigator.userAgent.match(pattern)
                        );
                    }
                }
                        ...
                        if (!IE11OrLess) {
                            do {
                                if (
                                    ...
                                    var containerRect =
                                        container.getBoundingClientRect(); // Set relative to edges of padding box of container

                                    top -=
                                        containerRect.top +
                                        parseInt(
                                            css(container, "border-top-width")
                                        );
                                    left -=
                                        containerRect.left +
                                        parseInt(
                                            css(container, "border-left-width")
                                        );
                ...
                function AnimationStateManager() {
                    ...
                    return {
                        ...
                        removeAnimationState: function removeAnimationState(
                            target
                        ) {
                        ...
                        animate: function animate(
                            ...
                            if (duration) {
                                ...
                                var elMatrix = matrix(this.el),
                                    ...
                                    scaleY = elMatrix && elMatrix.d,
                                    translateX =
                                        (currentRect.left - toRect.left) /
                                        (scaleX || 1),
                                    translateY =
                                        (currentRect.top - toRect.top) /
                                        (scaleY || 1);
                ...
                var PluginManager = {
                    ...
                    getEventProperties: function getEventProperties(
                        name,
                        sortable
                    ) {
                        var eventProperties = {};
                ...
                function dispatchEvent(_ref) {
                    ...
                    var evt,
                        ...
                        onName =
                            ...
                            name.substr(1); // Support for new CustomEvent feature
                        ...
                        _objectSpread2(
                            {
                                ...
                                dispatchSortableEvent:
                                    function dispatchSortableEvent(name) {
                                        _dispatchEvent({
                                            sortable: sortable,
                                            name: name,
                                            originalEvent: originalEvent,
                ...
                var documentExists = typeof document !== "undefined",
                    ...
                    CSSFloatProperty =
                        Edge || IE11OrLess ? "cssFloat" : "float",
                    ...
                    _detectDirection = function _detectDirection(el, options) {
                        ...
                        if (elCSS.display === "grid") {
                            return elCSS.gridTemplateColumns.split(" ")
                                .length <= 1
                                ? "vertical"
                                : "horizontal";
                        }
                    ...
                    _dragElInRowColumn = function _dragElInRowColumn(
                        ...
                        var dragElS1Opp = vertical
                                ? dragRect.left
                                : dragRect.top,
                            dragElS2Opp = vertical
                                ? dragRect.right
                                : dragRect.bottom,
                            dragElOppLength = vertical
                                ? dragRect.width
                                : dragRect.height,
                            targetS1Opp = vertical
                                ? targetRect.left
                                : targetRect.top,
                            targetS2Opp = vertical
                                ? targetRect.right
                                : targetRect.bottom,
                        ...
                        function toFn(value, pull) {
                            return function (to, from, dragEl, evt) {
                                ...
                                if (value == null && (pull || sameGroup)) {
                                    ...
                                    return toFn(
                                        value(to, from, dragEl, evt),
                                        pull
                                    )(to, from, dragEl, evt);
                                } else {
                                    var otherGroup = (pull ? to : from).options
                                        .group.name;
                                    return (
                                        value === true ||
                                        (typeof value === "string" &&
                ...
                Sortable.prototype =
                    /** @lends Sortable.prototype */
                    {
                        ...
                        _delayedDragTouchMoveHandler:
                            function _delayedDragTouchMoveHandler(
                        ...
                        _disableDelayedDragEvents:
                            function _disableDelayedDragEvents() {
                        ...
                        _onTouchMove: function _onTouchMove(
                            ...
                            if (tapEvt) {
                                var options = this.options,
                                    fallbackTolerance =
                                        options.fallbackTolerance,
                                    fallbackOffset = options.fallbackOffset,
                                    touch = evt.touches ? evt.touches[0] : evt,
                                    ghostMatrix =
                                        ghostEl && matrix(ghostEl, true),
                                    scaleX =
                                        ghostEl && ghostMatrix && ghostMatrix.a,
                                    scaleY =
                                        ghostEl && ghostMatrix && ghostMatrix.d,
                                ...
                                if (!Sortable.active && !awaitingDragStarted) {
                                    if (
                                        ...
                                        Math.max(
                                            Math.abs(
                                                touch.clientX - this._lastX
                                            ),
                                            Math.abs(
                                                touch.clientY - this._lastY
                                            )
                                        ) < fallbackTolerance
                                    ) {
                                        return;
                        ...
                        _appendGhost: function _appendGhost() {
                            ...
                            if (!ghostEl) {
                                ...
                                if (PositionGhostAbsolutely) {
                                    ...
                                    while (
                                        css(ghostRelativeParent, "position") ===
                                            "static" &&
                                        css(
                                            ghostRelativeParent,
                                            "transform"
                                    ...
                                    if (
                                        ...
                                        rect.left +=
                                            ghostRelativeParent.scrollLeft;
                                    } else {
                                        ghostRelativeParent =
                                            getWindowScrollingElement();
                                    }
                                ...
                                css(
                                    ...
                                    "transform-origin",
                                    (tapDistanceLeft /
                                        parseInt(ghostEl.style.width)) *
                                        100 +
                                        "% " +
                                        (tapDistanceTop /
                                            parseInt(ghostEl.style.height)) *
                                            100 +
                                        "%"
                                );
                            }
                        ...
                        _onDragStart: function _onDragStart(
                            ...
                            !fallback &&
                                toggleClass(dragEl, options.dragClass, true); // Set proper drop events

                            if (fallback) {
                                ignoreNextClick = true;
                                _this._loopId = setInterval(
                                    _this._emulateDragOver,
                                    50
                                );
                            } else {
                            ...
                            function completed(insertion) {
                                ...
                                if (insertion) {
                                    ...
                                    if (_this !== fromSortable) {
                                        ...
                                        fromSortable._ignoreWhileAnimating =
                                            null;
                                    }
                                ...
                                if (
                                    ...
                                    !insertion &&
                                        nearestEmptyInsertDetectEvent(evt);
                                }
                ...
                function _getSwapDirection(
                        ...
                        if (
                            ...
                            if (!pastFirstInvertThresh) {
                                ...
                                if (
                                    lastDirection === 1
                                        ? mouseOnAxis <
                                          targetS1 + targetMoveDistance // over dragEl shadow
                                        : mouseOnAxis >
                                          targetS2 - targetMoveDistance
                                ) {
                    ...
                    if (invert) {
                        ...
                        if (
                            mouseOnAxis <
                                targetS1 +
                                    (targetLength * invertedSwapThreshold) /
                                        2 ||
                            mouseOnAxis >
                                targetS2 -
                                    (targetLength * invertedSwapThreshold) / 2
                        ) {
                            return mouseOnAxis > targetS1 + targetLength / 2
                                ? 1
                                : -1;
                        }
                    }
                ...
                function AutoScrollPlugin() {
                    ...
                    AutoScroll.prototype = {
                        ...
                        _handleFallbackAutoScroll:
                            function _handleFallbackAutoScroll(evt) {
                                this._handleAutoScroll(evt, true);
                            },
                        _handleAutoScroll: function _handleAutoScroll(
                            evt,
                            fallback
                        ) {
                            var _this = this;

                            var x = (evt.touches ? evt.touches[0] : evt)
                                    .clientX,
                                y = (evt.touches ? evt.touches[0] : evt)
                                    .clientY,
                ...
                var autoScroll = throttle(function (
                    evt,
                    options,
                    rootEl,
                    isFallback
                                    ...
                                    function () {
                                        ...
                                        if (isFallback && this.layer === 0) {
                                            Sortable.active._onTouchMove(
                                                touchEvt$1
                                            ); // To move ghost if it is positioned absolutely
                                        }
                    ...
                    Swap.prototype = {
                        ...
                        drop: function drop(_ref3) {
                            ...
                            if (
                                lastSwapEl &&
                                (options.swap ||
                                    (putSortable && putSortable.options.swap))
                            ) {
                    ...
                    MultiDrag.prototype = {
                        ...
                        setupClone: function setupClone(_ref2) {
                            ...
                            for (var i = 0; i < multiDragElements.length; i++) {
                                multiDragClones.push(
                                    clone(multiDragElements[i])
                                );
                        ...
                        dragStartGlobal: function dragStartGlobal(_ref6) {
                            ...
                            multiDragElements = multiDragElements.sort(
                                function (a, b) {
                        ...
                        revert: function revert(_ref9) {
                            ...
                            if (multiDragElements.length > 1) {
                                ...
                                multiDragElements.forEach(function (
                                    ...
                                    fromSortable.removeAnimationState(
                                        multiDragElement
                                    );
                                });
                                folding = false;
                                ...
                                if (!isOwner) {
                                    ...
                                    if (multiDragElements.length > 1) {
                                        ...
                                        if (
                                            ...
                                            multiDragClones.forEach(function (
                                                clone
                                            ) {
                        ...
                        dragOverAnimationCapture:
                            function dragOverAnimationCapture(_ref11) {
                            ...
                            if (!dragStarted) {
                                ...
                                if (!~multiDragElements.indexOf(dragEl$1)) {
                                    ...
                                    if (
                                        evt.shiftKey &&
                                        lastMultiDragSelect &&
                                        sortable.el.contains(
                                            lastMultiDragSelect
                                        )
                                    ) {
                                        var lastIndex =
                                                index(lastMultiDragSelect),
                ...
                function removeMultiDragElements() {
                    multiDragElements.forEach(function (multiDragElement) {
                        ...
                        multiDragElement.parentNode &&
                            multiDragElement.parentNode.removeChild(
                                multiDragElement
                            );
                    });
                }
  ...
  \************************/
        ...
        /* harmony import */ var graph_tabs__WEBPACK_IMPORTED_MODULE_1__ =
            __webpack_require__(
                /*! graph-tabs */ "./node_modules/graph-tabs/src/graph-tabs.js"
            );
        /* harmony import */ var sortablejs__WEBPACK_IMPORTED_MODULE_2__ =
            __webpack_require__(
                /*! sortablejs */ "./node_modules/sortablejs/modular/sortable.esm.js"
            );
        /* harmony import */ var _vendor_datatables_ru_json__WEBPACK_IMPORTED_MODULE_3__ =
            __webpack_require__(
                /*! ./vendor/datatables-ru.json */ "./src/js/vendor/datatables-ru.json"
            );
        /* harmony import */ var _components__WEBPACK_IMPORTED_MODULE_4__ =
        ...
        if (document.querySelector(".profile__tabs")) {
            const tabs = new graph_tabs__WEBPACK_IMPORTED_MODULE_1__["default"](
                "profile"
            );
        }
        ...
        if (cropAvaPopup) {
            ...
            const croppieContainer =
                cropAvaPopup.querySelector("#croppieContainer");
            const cropBtn = cropAvaPopup.querySelector("#cropBtn");
            const imgWrap = uploadInput.querySelector(
                ".js-upload-widget-preview"
            );
            let croppieInstance;
            const modal = new graph_modal__WEBPACK_IMPORTED_MODULE_0__[
                "default"
            ]("cropp-ava");
        ...
        if (cropCoverPopup) {
            ...
            const croppieContainer =
                cropCoverPopup.querySelector("#croppieContainer");
        ...
        if (cropGalerryPopup) {
            ...
            const croppieContainer =
                cropGalerryPopup.querySelector("#croppieContainer");
      ...
      `;
                        ...
                        var sortable =
                            sortablejs__WEBPACK_IMPORTED_MODULE_2__[
                                "default"
                            ].create(galleryWrap);
                        const galerryImgs =
                        ...
                        if (galerryImgs.length != 0) {
                            galerryImgs.forEach((galerryImg) => {
                                const galerryImgCloseBtn =
                                    galerryImg.querySelector(
                                        ".gallery-img__close"
                                    );
                                galerryImgCloseBtn.addEventListener(
                                    "click",
                                    () => {
                                        if (galerryImg == galerryImgs[0]) {
                                            galleryWrap.style.marginBottom =
                                                "0";
                                        }
        ...
        $("#register-form").validate({
            ...
            messages: {
                reg_name: {
                    maxlength:
                        "Имя и фамилия должны быть не более 50-и символов",
                },
            },
        });
        $("#collecting").validate({
        ...
        $("#moderate").validate({
            ...
            submitHandler: function (form) {
                new graph_modal__WEBPACK_IMPORTED_MODULE_0__["default"]().open(
                    "success"
                );
                const moderatePopup = document.querySelector(".popup-moderate");
                moderatePopup.classList.remove(
                    "graph-modal-open",
                    "fade",
                    "animate-open"
                );
        ...
        $("#published").validate({
            ...
            submitHandler: function (form) {
                ...
                const moderatePopup =
                    document.querySelector(".popup-published");
                moderatePopup.classList.remove(
                    "graph-modal-open",
                    "fade",
                    "animate-open"
        ...
        const inputDateCheckbox = document.querySelector(
            ".input-date__checkbox input"
        );

        if (inputDateCheckbox) {
            const inputDateWrap = document.querySelector("#input-date-wrap");
            const inputDateInput = inputDateWrap.querySelector("input");
            const submitButton = document.querySelector("#publish");

            inputDateCheckbox.addEventListener("change", () => {
                const inputError = inputDateWrap.querySelectorAll(".error");

                if (inputDateCheckbox.checked) {
                    inputDateWrap.classList.add("unavailable");
                    inputDateInput.classList.add("unavailable");
                    inputError[0].classList.remove("error");
                    inputError[1].style.display = "none";
                } else {
                    inputDateWrap.classList.remove("unavailable");
                    inputDateInput.classList.remove("unavailable");
                    inputError[0].classList.add("error");
        ...
        function addFile(files, item) {
            for (let i = 0; i < files.length; i++) {
                ...
                if (file.size > 10 * 1024 * 1024) {
                    ...
                    item.querySelectorAll(".file-form__item").forEach((el) =>
                        el.remove()
                    );
                    item.parentNode.querySelector(".content-block-more.next-step-proj").classList.add("disabled")
                    return;
                    ...
                    item.parentNode.querySelector(".content-block-more.next-step-proj").classList.remove("disabled")
                    let reader = new FileReader();
                    reader.readAsDataURL(file);
                    reader.onload = () => {
                        item.querySelector(
                            ".file-form__items"
                        ).innerHTML += `<div class="file-form__item">
                         <div class="file-form__name">${file.name}</div>
                         <div class="file-form__del"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20" fill="none">
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M15.538 16.25L3.95846 4.47407L4.67046 3.75L16.25 15.5259L15.538 16.25Z" fill="#41536D"/>
                            <path fill-rule="evenodd" clip-rule="evenodd" d="M3.75 15.5259L15.3295 3.75L16.0415 4.47407L4.462 16.25L3.75 15.5259Z" fill="#41536D"/>
                          </svg></div>
                        </div>
                       `;
                    };
        ...
        if (document.querySelectorAll(".file-form").length > 0) {
          document.querySelectorAll(".file-form").forEach((item) => {
            ...
            item.addEventListener("click", (e) => {
                item.querySelectorAll(".file-form__del").forEach(
                    (del, idx) => {
            ...
            item.querySelector(".file-form__top").addEventListener("dragenter", (e) => {
                e.preventDefault();
            });
            item.querySelector(".file-form__top").addEventListener("dragover", (e) => {
                e.preventDefault();
            });
            item.querySelector(".file-form__top").addEventListener("dragleave", (e) => {
                e.preventDefault();
            });
            item.querySelector(".file-form__top").addEventListener("drop", function (e) {
                e.preventDefault();
